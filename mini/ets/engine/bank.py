...
class Bank:
    ...
    def __init__(self):
        ...
        self.type_choice=['savings','current','ppf','demat']
        self.active_choice=['true','false']
        self.card_choice=['credit','debit']
    def auto_generate(self):
        self.type =random.choice(self.type_choice)
        self.active =random.choice(self.active_choice)
        self.balance =random.randint(1111,99999)
        self.transact =str(self.f.xxxxx())
        self.card =random.choice(s
                                 
                                 elf.card_choice)
        self.user_id =str(self.f.user_name())
        self.loan =str(self.f.xxxxx())
        self.account_id =str(self.f.xxxxx())
